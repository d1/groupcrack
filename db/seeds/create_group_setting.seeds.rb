...
if seed_file.nil?
  ...
  create_group_setting.setting_values.create(name: "Everyone", 
    position: 1,
    locked: 1,
    default_value: 1 )
  create_group_setting.setting_values.create(name: "Specified Users", 
    position: 2,
    locked: 1 )
  ...
  create_group_setting = SettingType.create(name: "Create New Organizations User Access Right", 
    description: "Ability to add new organizations to site",
    locked: 1,
    site_or_org_specific: 'site',
    user_specific: 1
